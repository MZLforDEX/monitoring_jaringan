...
- **Kustomisasi Metrik Penuh**: Pengguna dapat memilih dan mengatur metrik apa saja yang ingin dimunculkan pada widget melayang langsung dari aplikasi utama.
...
```bash
adb install -r NetworkMonitor-v0.1.2-debug.apk
```
